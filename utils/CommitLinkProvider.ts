// Base https://github.com/xtermjs/xterm.js/blob/d6599bc048/addons/xterm-addon-web-links/src/WebLinkProvider.ts
...
export class CommitLinkProvider implements ILinkProvider {

    constructor(
        private readonly _terminal: Terminal,
        private readonly _regex: RegExp,
        private readonly _handler: (event: MouseEvent, commit: string) => void,
    ...
    private _addCallbacks(links: ILink[]): ILink[] {
        return links.map(link => {
            ...
            link.hover = (event: MouseEvent, commit: string): void => {
                if (this._options.hover) {
                    const { range } = link;
                    this._options.hover(event, commit, range);
                }
            };
            return link;
        });
...
export class LinkComputer {
    public static computeLink(y: number, regex: RegExp, terminal: Terminal, activate: (event: MouseEvent, commit: string) => void): ILink[] {
